...
namespace Lol.ExampleData.History
{
	public partial class ExamHistory
	{
		...
		public static List<HistoryModel> GetHistory()
		{
			...
			static string ItemImageResource(string name) => $"/Lol.Resources;component/Images/Items/{name}.png";
			...
			List<HistoryModel> source = new()
			{
			    ...
			    Item1 = "Potion", Item2 = "Solari", Item3 = "Shoose", Item4 = "Zhonya", Item5 = "Warmog", Item6 = "Rabadon", Item7 = "Quicksilver"},
