...
namespace Lol.Store.UI.Views
{
    ...
    /// 추가합니다.
    ///
    ///     xmlns:MyNamespace="clr-namespace:Lol.Store.Themes.Views"
    ///
    ///
    ...
    /// 추가합니다.
    ///
    ///     xmlns:MyNamespace="clr-namespace:Lol.Store.Themes.Views;assembly=Lol.Store.Themes.Views"
    ///
    ...
    public class EtcView : JamesContent
    {
        ...
        static EtcView()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(EtcView), new FrameworkPropertyMetadata(typeof(EtcView)));
        }
        #endregion
    }
}
